...
(function (document, window, $) {
    ...
    window.Content = {
        ...
        taskTpl: function (data) {
            return '<li class="list-group-item priority-' + data.priority + '" data-taskboard="slidePanel" data-url="'+ $.ctx +'/public/data/examples/pages/taskboard-panel.tpl">' +
                ...
                '<li><img class="avatar avatar-sm" src="' + $.ctx + '/public/images/portraits/5.jpg"></li>' +
                '</div>' +
                '</li>';
        },
        ...
        membersTpl: function (src) {
            ...
            if(_url.indexOf($.ctx) !== -1){
                _url = _url.replace($.ctx, '');
            }

            return '<li><img class="avatar avatar-sm" src="' + $.ctx + _url + '"></li>';
        },
            ...
            $pageContent.on('click', '[data-taskboard="slidePanel"]', function (e) {
                ...
                $.slidePanel.show({
                    ...
                    contentFilter: function (data, object) {
                        ...
                        $('.comments-user-img>img', $panel).prop('src', $.ctx + '/public/images/portraits/5.jpg');
                        return $panel;
                    }
                }));
        ...
        handleSelective: function ($target, selected) {
            ...
            var members = [{
                id: 'uid_1',
                name: '梅小燕',
                img: $.ctx + '/public/images/portraits/1.jpg'
            }, {
                id: 'uid_2',
                name: '赵桦',
                img: $.ctx + '/public/images/portraits/2.jpg'
            }, {
                id: 'uid_3',
                name: '唐雪琴',
                img: $.ctx + '/public/images/portraits/3.jpg'
            }, {
                id: 'uid_4',
                name: '曹洁群',
                img: $.ctx + '/public/images/portraits/4.jpg'
            }, {
                id: 'uid_5',
                name: '陈媚婉',
                img: $.ctx + '/public/images/portraits/5.jpg'
            }, {
                id: 'uid_6',
                name: '嵇慧莉',
                img: $.ctx + '/public/images/portraits/6.jpg'
            }];
            ...
            $target.selective({
                ...
                tpl: {
                    ...
                    item: function (data) {
                        ...
                        return '<li class="' + this.namespace + '-item"><img class="avatar" src="' + $.ctx + _url + '">' +
