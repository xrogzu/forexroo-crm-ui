...
<link rel="stylesheet" href="${ctx}/public/css/examples/charts/chartjs.css">
...
<script src="${ctx}/public/vendor/chart-js/Chart.js" data-name="Chart"></script>
<script src="${ctx}/public/js/examples/charts/chartjs.js" data-deps="Chart"></script>
