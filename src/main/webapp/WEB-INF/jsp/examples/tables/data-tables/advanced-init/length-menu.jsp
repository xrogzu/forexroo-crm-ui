...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">自定义长度菜单</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>使用 <code>lengthMenu</code> 选项来初始化选项，此选项支持两种参数方式，一种是一维数组，一种是二维数组，此例子演示的是二维数组的用法</p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/length-menu.js"></script>