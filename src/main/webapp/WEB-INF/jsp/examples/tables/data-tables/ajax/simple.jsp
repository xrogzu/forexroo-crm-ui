...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Ajax数据源（数组）</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例展示 DataTables 最简单的 Ajax 数据源的用法</p>
    </div>
    ...
    "data": [
        ...
        [
            ...
            <div class="tab-pane" id="DTHtml" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full" data-plugin="dataTable" data-ajax="data/examples/tables/dt-ajax.json"&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;姓名&lt;/th&gt;
        &lt;th&gt;职位&lt;/th&gt;
