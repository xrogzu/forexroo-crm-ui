...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">在回调方法中使用API</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>有时候希望给表格绑定的数据行绑定一些事件，这个时候你需要用到 <code>initComplete</code> 、<code>rowCallback</code>
            这些回调方法，下面的示例演示了，当表格加载完后给表格的td绑定点击事件，取到值后进行搜索</p>
    </div>
