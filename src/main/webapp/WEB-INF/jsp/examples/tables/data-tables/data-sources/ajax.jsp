...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Ajax数据源</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>DataTables 可以通过 <code>ajax</code> 设置ajax数据源获取json数据</p>
    </div>
    <div class="panel-body">
        <table class="table table-bordered table-hover dataTable table-striped width-full text-nowrap" id="dataTableExample" data-plugin="dataTable" data-ajax="${ctx}/public/data/examples/tables/dt-ajax.json">
            <thead>
            <tr>
                <th>姓名</th>
                <th>职位</th>
    ...
    "data": [
        ...
        [
            ...
            <div class="tab-pane" id="DTHtml" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full" data-plugin="dataTable" data-ajax="${ctx}/public/data/examples/tables/dt-ajax.json"&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;姓名&lt;/th&gt;
        &lt;th&gt;职位&lt;/th&gt;
