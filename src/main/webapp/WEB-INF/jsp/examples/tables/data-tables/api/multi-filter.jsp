...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">给每一列添加搜索框</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例演示了在每一列上添加一个搜索框</p>
    </div>
...
<div class="panel nav-tabs-horizontal">
    <div class="panel-body" data-approve="nav-tabs">
		...
		<pre data-plugin="highlight"><code class="js">// 安装 - 在foot每个单元格中添加文本框
...
<script src="${ctx}/public/js/examples/tables/data-tables/api/multi-filter.js"></script>