...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">添加索引列</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例演示了在表格每一列加上索引</p>
    </div>
    ...
    function () {
        t.column(0, {
            ...
            <div class="tab-pane" id="DTHtml" role="tabpanel">
				<pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full text-nowrap"
       id="dataTableExample"&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;&lt;/th&gt;
...
<script src="${ctx}/public/js/examples/tables/data-tables/api/counter-columns.js"></script>