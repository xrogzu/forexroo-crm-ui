...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">默认设置</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>在多个页面使用 DataTables，你可能将 <code>dom</code> 设置为公共的值，让所有的表格都有相同的布局，这个时候你可以使用 <code>$.fn.dataTable.defaults</code>
            当设置此对象后，所有 DataTables 在初始化的时候都会使用这个参数设置</p>
        <p>此例子演示了默认禁用搜索和排序功能</p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/defaults.js"></script>