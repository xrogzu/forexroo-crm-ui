...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">给一列生成自定义内容</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>在某些情况下你可能需要自动创建内容，这时你可以使用 <code>columns.render</code> 参数，来渲染每一行数据</p>
        <p>对于简单的静态的数据可以使用 <code>columns.defaultContent</code> 参数</p>
        <p>本示例演示如何使用 <code>columns.defaultContent</code> 在表的最后一列中创建按钮并添加点击事件，通过 <code>row().data()</code>
            方法得到这行的数据，并打印出相关信息</p>
        <p>此外注意到列中的 <code>columns.data</code> 选项已被设置为 <code>null</code>，表示列不会获得数据源对象的信息。</p>
    </div>
...
$('#dataTableExample tbody').on('click', 'button', function () {
...
<script src="${ctx}/public/js/examples/tables/data-tables/ajax/null-data-source.js"></script>