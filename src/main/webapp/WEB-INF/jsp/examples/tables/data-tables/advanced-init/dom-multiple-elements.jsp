...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">多个表格操作元素</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>你可以使用 <code>dom</code> 来定位 DataTables 的一些控件，比如搜索框，分页控件等等，此例子演示了在表格上面和下面同时显示长度菜单，分页菜单和搜索框</p>
        <p>注意，很明显表格控件应该只要使用一次</p>
    </div>
    <div class="panel-body dt-dom-multiple-elements">
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/dom-multiple-elements.js"></script>