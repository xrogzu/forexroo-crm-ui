...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">垂直滚动条 - 动态高度</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例演示垂直滚动条,它使用CSS3 <code>vh</code> 作为单位,以便根据浏览器窗口大小动态调整高度, <code>vh</code> 实际上是浏览器高度的百分比,因此,在该示例中使用的 <code>50vh</code>
            是窗口高度的50％。当窗口调整大小时，视口大小将会动态更新</p>
        <p>请调整浏览器大小查看效果</p>
    </div>
    <div class="panel-body">
        <table class="table table-bordered table-hover dataTable table-striped width-full text-nowrap" id="dataTableExample" data-plugin="dataTable" data-scroll-y="50vh" data-scroll-collapse="true" data-paging="false">
            <thead>
            <tr>
                <th>姓名</th>
                <th>职位</th>
    ...
    <div class="panel-body" data-approve="nav-tabs">
        ...
        <div class="tab-content margin-top-15">
            <div class="tab-pane active" id="DTDataApi" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">data-plugin="dataTable" data-scroll-y="50vh" data-scroll-collapse="true" data-paging="false"</code></pre>
            </div>
    ...
    $('#dataTableExample').DataTable($.po('dataTable', {
        ...
        "paging":         false
            ...
            <div class="tab-pane" id="DTHtml" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full text-nowrap" id="dataTableExample" data-plugin="dataTable" data-scroll-y="50vh" data-scroll-collapse="true" data-paging="false"&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;姓名&lt;/th&gt;
        &lt;th&gt;职位&lt;/th&gt;
