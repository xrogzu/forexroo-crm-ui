...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">表格foot回调</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>此例子演示通过 <code>footerCallback</code> 回调函数统计"年薪"总额</p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/footer-callback.js"></script>