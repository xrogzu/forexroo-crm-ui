...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">高级排序控制</h3>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/sort-direction-control.js"></script>