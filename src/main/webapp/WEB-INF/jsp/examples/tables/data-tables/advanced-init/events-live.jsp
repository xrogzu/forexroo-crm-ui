...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">DOM/jQuery 事件</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p><code>table</code> 上分配的事件在用户交互时非常有用，但是我们需要知道，DataTables 会在需要是从 <code>DOM</code> 中添加或删除行，因此，这可能会导致事件出现一些问题</p>
        <p>处理这种情况的最好办法之一是通过使用事件委托与 jQuery 的 <code>on</code> 方法，如本例所示。 本示例还使用 DataTables 的<code>row().data()</code>
            方法检索有关所选行的数据，我们可以在在 <code>toastr</code> 中显示所选行信息</p>
    </div>
    ...
    $('#dataTableExample tbody').on('click', 'tr', function () {
        ...
        toastr.info('您单击了"' + data[0] + '"的行');
            ...
            <div class="tab-pane" id="DTHtml" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full" id="dataTableExample"&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;姓名&lt;/th&gt;
        &lt;th&gt;职位&lt;/th&gt;
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/events-live.js"></script>