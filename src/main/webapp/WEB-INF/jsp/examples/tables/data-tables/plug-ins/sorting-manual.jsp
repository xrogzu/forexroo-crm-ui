...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">排序插件（无类型检测）</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例和另一个有点不同，这个是针对所有列，所以不能加入类型判断。 本示例用上了 <code>columns.typeOption</code> 属性，同样使用了 <code>$.fn.dataTable.ext.type.order</code>
            方法定义了排序的规则</p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/plug-ins/sorting-manual.js"></script>