...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">自定义工具按钮元素</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>此例子其实就是dom的高级应用，熟练使用 <code>dom</code>，可以把给 Datatables 添加自定义按钮或者其他工具，使其看起来是一个整体 </p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/dom-toolbar.js"></script>