...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">对象数据源</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>DataTables 期望服务器端处理的默认数据格式是一个2D数据数据（行和列）。 但是，这对于服务器端环境通常不够灵活，或者您可能希望在数据源中添加比在 table
            中显示所需的更多信息（如数据库中的行ID）。对于这些情况，DataTable 支持读取对象以及数组的数据。）</p>
...
<script src="${ctx}/public/js/examples/tables/data-tables/server-side/object-data.js"></script>