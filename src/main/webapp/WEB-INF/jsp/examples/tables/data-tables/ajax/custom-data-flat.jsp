...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">不指定数据源属性</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>当从 Ajax 源加载数据，在默认情况下，数据表将寻找要使用返回的对象的数据参数中的数据 （例如 {"data"： [……]}）。 通过使用 ajax 选项的 <code>dataSrc</code>
            启动选项来改变属性</p>
        <p><code>dataSrc</code> 有许多用法如下：</p>
        <ul>
            <li>作为一个字符串，如 <code>dataSrc: 'myData'</code></li>
            <li>为空字符串，如 <code>dataSrc:""</code>，本示例展示次用法</li>
            <li>作为一个方法，如 <code>dataSrc： function(json) {}</code> （您可以从 XML 转换到一个 Javascript 对象）</li>
        </ul>
...
<script src="${ctx}/public/js/examples/tables/data-tables/ajax/custom-data-flat.js"></script>