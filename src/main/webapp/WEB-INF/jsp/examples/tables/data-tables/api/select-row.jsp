...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">选择行</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例演示了怎么获取选中行数</p>
    </div>
    <div class="panel-body">
        <button type="button" class="btn btn-success margin-bottom-15" id="DTSelectRow">获取选中行数</button>
...
$('#DTSelectRow').click(function () {
    toastr.info('选中了 ' + table.rows('.selected').data().length + ' 行数据');
            ...
            <div class="tab-pane" id="DTHtml" role="tabpanel">
				<pre data-plugin="highlight"><code class="html">&lt;button type="button" class="btn btn-success margin-bottom-15" id="DTSelectRow"&gt;获取选中行数&lt;/button&gt;
...
<script src="${ctx}/public/js/examples/tables/data-tables/api/select-row.js"></script>