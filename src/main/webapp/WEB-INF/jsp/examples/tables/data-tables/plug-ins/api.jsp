...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">API插件方法</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>DataTables API是一个完全可扩展的设计，使用 <code>$.fn.dataTable.Api.register</code> 方法可以很容易的添加函数</p>
        <p>这个函数接受两个参数：第一个被添加的方法的名称(jquery的链式层次),第二个是函数本身</p>
        <p>本示例展示了如何把 <code>sum()</code> 方法添加到api中，得到一列的总和。 由于链式的写法，可以让 <code>sum()</code>
            方法作用到任何一个被选中的列，也可以限制到当前页过滤后的数据或者所有页面。 这个是使用 <code>column()</code> 方法来完成的</p>
    </div>
    <div class="panel-body">
        <div class="btn-group margin-bottom-20" role="group" id="dataTableExampleButton"></div>
    ...
    $('&lt;button type="button" class="btn btn-outline btn-default"&gt;点击计算可见行年龄列的总和&lt;/button&gt;')
        ...
        .on('click', function () {
            ...
            <div class="tab-pane" id="DTHtml" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full&quot&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;姓名&lt;/th&gt;
        &lt;th&gt;职位&lt;/th&gt;
...
<script src="${ctx}/public/js/examples/tables/data-tables/plug-ins/api.js"></script>