...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">垂直滚动条</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>如果在一个固定高度的容器里放表格，这个时候可能需要用到垂直滚动条，才能展示所有数据。</p>
        <p>开启垂直滚动条很简单，只要设置 <code>scrollY</code> 和 <code>scrollCollapse</code> 选项即可</p>
    </div>
    <div class="panel-body">
        <table class="table table-bordered table-hover dataTable table-striped width-full text-nowrap" id="dataTableExample" data-plugin="dataTable" data-scroll-y="200px" data-scroll-collapse="true" data-paging="false">
            <thead>
            <tr>
                <th>姓名</th>
                <th>职位</th>
    ...
    <div class="panel-body" data-approve="nav-tabs">
        ...
        <div class="tab-content margin-top-15">
            <div class="tab-pane active" id="DTDataApi" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">data-plugin="dataTable" data-scroll-y="200px" data-scroll-collapse="true" data-paging="false"</code></pre>
            </div>
    ...
    $('#dataTableExample').DataTable($.po('dataTable', {
        ...
        "paging":         false
            ...
            <div class="tab-pane" id="DTHtml" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full text-nowrap" id="dataTableExample" data-plugin="dataTable" data-scroll-y="200px" data-scroll-collapse="true" data-paging="false"&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;姓名&lt;/th&gt;
        &lt;th&gt;职位&lt;/th&gt;
