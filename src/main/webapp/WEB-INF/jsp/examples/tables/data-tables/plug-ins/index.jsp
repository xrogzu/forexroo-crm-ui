...
<div class="page page-full animation-fade page-data-tables">
    <div class="page-aside">
        ...
        <div class="page-aside-inner height-full" data-plugin="slimScroll">
            <section class="page-aside-section">
                <h5 class="page-aside-title">插件</h5>
                <div class="list-group">
                    <a class="list-group-item" href="${ctx}/tables/data-tables/plug-ins/api" data-pjax="#DTConent">
                        <i class="icon fa-circle-o"></i> API插件方法
                    </a>
                    <a class="list-group-item" href="${ctx}/tables/data-tables/plug-ins/sorting-auto" data-pjax="#DTConent">
                        <i class="icon fa-circle-o"></i> 排序插件（类型检测）
                    </a>
                    <a class="list-group-item" href="${ctx}/tables/data-tables/plug-ins/sorting-manual" data-pjax="#DTConent">
                        <i class="icon fa-circle-o"></i> 排序插件（无类型检测）
                    </a>
                    <a class="list-group-item" href="${ctx}/tables/data-tables/plug-ins/range-filtering" data-pjax="#DTConent">
                        <i class="icon fa-circle-o"></i> 自定义过滤 - 范围搜索
                    </a>
                    <a class="list-group-item" href="${ctx}/tables/data-tables/plug-ins/dom-sort" data-pjax="#DTConent">
                        <i class="icon fa-circle-o"></i> dom对象排序
                    </a>
                </div>
            </section>
        </div>
    ...
    <div class="page-main">
        <div class="page-header">
            <h1 class="page-title">DataTables 插件</h1>
