...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Html(DOM)数据源</h3>
    </div>
    ...
    <div class="panel-body" data-approve="nav-tabs">
        ...
        <div class="tab-content margin-top-15">
            ...
            <div class="tab-pane" id="DTJS" role="tabpanel">
                <pre data-plugin="highlight"><code class="js">$('#dataTableExample').DataTable($.po('dataTable'));</code></pre>
            </div>
            <div class="tab-pane" id="DTHtml" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full" data-plugin="dataTable"&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;姓名&lt;/th&gt;
        &lt;th&gt;职位&lt;/th&gt;
