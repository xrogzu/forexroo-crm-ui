...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">列渲染</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例演示了把年龄列隐藏，通过 <code>columns.render</code> 方法把年龄的值拼接到姓名列</p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/column-render.js"></script>