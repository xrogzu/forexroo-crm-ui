...
<div class="panel">
    ...
    <div class="alert alert-warning" role="alert">
        <p>DOM 数据源是 DataTables 最基本的用法，下面演示了html静态数据使用 DataTables 实现过滤，排序，分页</p>
    </div>
    <div class="panel-body">
        <table class="table table-bordered table-hover dataTable table-striped width-full text-nowrap" id="dataTableExample" data-plugin="dataTable" data-processing="true" data-server-side="true" data-ajax="${ctx}/public/data/examples/tables/dt-server-processing.json">
            <thead>
            <tr>
                <th>姓名</th>
                <th>职位</th>
...
<div class="panel nav-tabs-horizontal">
    <div class="panel-body" data-approve="nav-tabs">
        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
            ...
            <li role="presentation">
                <a data-toggle="tab" href="#DTJson" aria-controls="DTJson" role="tab" aria-expanded="true">DATA</a>
            </li>
        </ul>
        <div class="tab-content margin-top-15">
            <div class="tab-pane active" id="DTDataApi" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">data-plugin="dataTable" data-processing="true" data-server-side="true" data-ajax="路径"</code></pre>
            </div>
            <div class="tab-pane" id="DTJS" role="tabpanel">
                <pre data-plugin="highlight"><code class="js">js代码</code></pre>
            </div>
            <div class="tab-pane" id="DTHtml" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full" data-plugin="dataTable" data-processing="true" data-server-side="true" data-ajax="${ctx}/public/data/examples/tables/dt-server-processing.json"&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;姓名&lt;/th&gt;
        &lt;th&gt;职位&lt;/th&gt;
