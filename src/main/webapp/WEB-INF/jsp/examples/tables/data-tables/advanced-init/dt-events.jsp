...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">DataTables 事件</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>DataTables 有几个自定义事件，你可以用代码处理这些，比如当搜索事件触发的时候你要处理什么事情。本示例演示使用当触发了搜索、排序、分页事件后打印日志</p>
    </div>
    <div class="panel-body">
        <div class="well">
            <h5>DataTables 事件</h5>
            <div id="dataTableEventDemoInfo"></div>
        </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/dt-events.js"></script>