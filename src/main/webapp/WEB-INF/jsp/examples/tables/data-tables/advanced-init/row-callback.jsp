...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">创建行回调</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>此例子演示了，当"年薪"大于400000的时候用高亮显示，注意 <code>columns.createdCell</code> 选项也可以实现同样的效果</p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/row-callback.js"></script>