...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">行分组</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>此例子演示了以"工作地点"分组数据，同时隐藏"工作地点"这一列</p>
    </div>
...
<div class="panel nav-tabs-horizontal">
    ...
    // 分组排序
    $('#dataTableExample tbody').on('click', 'tr.group', function () {
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/row-grouping.js"></script>