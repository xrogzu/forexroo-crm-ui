...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">显示行的附加信息</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例演示了Ajax调用服务器来获得行的附加信息</p>
    </div>
...
<div class="panel nav-tabs-horizontal">
    <div class="panel-body" data-approve="nav-tabs">
        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
            ...
            <li role="presentation">
                <a data-toggle="tab" href="#DTAjax" aria-controls="DTAjax" role="tab" aria-expanded="true">AJAX</a>
            </li>
        </ul>
        <div class="tab-content margin-top-15">
            <div class="tab-pane active" id="DTJS" role="tabpanel">
		<pre data-plugin="highlight"><code class="js">/* 格式化详情功能 - 根据需要修改 */
function format(d) {
    // `d` 是该行的原始数据对象
...
$(function () {
    ...
    // 展开关闭详情时的事件监听
    $('#dataTableExample tbody').on('click', 'td.details-control', function () {
...
<script src="${ctx}/public/js/examples/tables/data-tables/api/row-details.js"></script>