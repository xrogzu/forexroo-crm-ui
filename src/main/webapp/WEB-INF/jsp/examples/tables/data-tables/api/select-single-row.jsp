...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">选择行并删除</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例演示了怎么获取选中行数</p>
    </div>
    <div class="panel-body">
        <button type="button" class="btn btn-success margin-bottom-15" id="DTDelRow">删除选中行数</button>
...
$('#DTSelectRow').click(function () {
    toastr.info('选中了 ' + table.rows('.selected').data().length + ' 行数据');
});</code></pre>
            </div>
            <div class="tab-pane" id="DTHtml" role="tabpanel">
				<pre data-plugin="highlight"><code class="html">&lt;button type="button" class="btn btn-success margin-bottom-15" id="DTDelRow"&gt;删除选中行数&lt;/button&gt;
...
<script src="${ctx}/public/js/examples/tables/data-tables/api/select-single-row.js"></script>