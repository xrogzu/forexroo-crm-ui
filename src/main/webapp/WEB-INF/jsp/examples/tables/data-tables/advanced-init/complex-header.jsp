...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">隐藏列的复杂的表头</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>通过 <code>rowspan</code> / <code>colspan</code> 制作复杂的表头，下面的例子演示如何隐藏"年龄"一列</p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/complex-header.js"></script>