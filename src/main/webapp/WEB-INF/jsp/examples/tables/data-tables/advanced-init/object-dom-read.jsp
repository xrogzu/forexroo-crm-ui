...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">把HTML转化为DT内部数据对象</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>DataTables 使用 <code>dom</code> 作为数据源的时候，DataTables 会读表格中的信息到一个内部的一个数组储存，而你可以通过 <code>columns.data</code>
            属性定义获取到， 如果你是使用ajax获取数据，那么这个属性将告诉 DataTables 如何去取数据源中对应列的数据，如果是 <code>dom</code> 数据源，这个属性将告诉你数据写入的位置</p>
        <p>下面的例子演示了如果绑定数据到 DataTables</p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/advanced-init/object-dom-read.js"></script>