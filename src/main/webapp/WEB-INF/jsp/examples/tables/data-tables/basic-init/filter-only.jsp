...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">功能启用/禁用</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        如果你不想使用 DataTables 的某项特性，那么你可以禁用它，下面的例子展示了只启用查找功能(默认是启用的)
    </div>
    <div class="panel-body">
        <table class="table table-bordered table-hover dataTable table-striped width-full text-nowrap" id="dataTableExample" data-plugin="dataTable" data-plugin="dataTable" data-paging="false" data-ordering="false" data-info="false">
            <thead>
            <tr>
                <th>姓名</th>
                <th>职位</th>
...
<div class="panel nav-tabs-horizontal">
    <div class="panel-body" data-approve="nav-tabs">
        ...
        <div class="tab-content margin-top-15">
            <div class="tab-pane active" id="DTDataApi" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">data-plugin="dataTable" data-paging="false" data-ordering="false" data-info="false"</code></pre>
            </div>
    ...
    "info":     false
            ...
            <div class="tab-pane" id="DTHtml" role="tabpanel">
                <pre data-plugin="highlight"><code class="html">&lt;table class="table table-bordered table-hover dataTable table-striped width-full" id="dataTableExample" data-plugin="dataTable" data-plugin="dataTable" data-paging="false" data-ordering="false" data-info="false"&gt;
    &lt;thead&gt;
    &lt;tr&gt;
        &lt;th&gt;姓名&lt;/th&gt;
        &lt;th&gt;职位&lt;/th&gt;
