...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Ajax数据源（对象）</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>通过使用 <code>columns.data</code> 选项用于告诉 DataTables 找到每一列的数据源对象中对应的属性</p>
    </div>
...
<script src="${ctx}/public/js/examples/tables/data-tables/ajax/objects.js"></script>