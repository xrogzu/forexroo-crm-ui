...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">高亮鼠标停留的行和列</h3>
    </div>
    <div class="alert alert-warning" role="alert">
        <p>本示例演示了用户的光标是在一个表中，突出的行和列，如果你有很多狭窄的列非常有用</p>
    </div>
...
<div class="panel nav-tabs-horizontal">
    <div class="panel-body" data-approve="nav-tabs">
		...
		<pre data-plugin="highlight"><code class="js">var lastIdx = null;
var table = $('#dataTableExample').DataTable($.po('dataTable'));
$('#dataTableExample tbody')
...
<script src="${ctx}/public/js/examples/tables/data-tables/api/highlight.js"></script>