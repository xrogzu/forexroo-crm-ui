...
<link rel="stylesheet" href="${ctx}/public/css/examples/pages/home/analytics.css">
                    ...
                    <div class="widget-content">
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <table class="table table-analytics margin-bottom-0">
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/browser/360.png" width="36" title="360浏览器" alt="360浏览器">
                                    </td>
                                    <td>
                                        360浏览器
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/browser/sogou.png" width="36" title="搜狗浏览器" alt="搜狗浏览器">
                                    </td>
                                    <td>
                                        搜狗浏览器
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/browser/ie.png" width="36" title="IE浏览器" alt="IE浏览器">
                                    </td>
                                    <td>
                                        IE浏览器
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/browser/baidu.png" width="36" title="百度浏览器" alt="百度浏览器">
                                    </td>
                                    <td>
                                        百度浏览器
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/browser/qq.png" width="36" title="QQ浏览器" alt="QQ浏览器">
                                    </td>
                                    <td>
                                        QQ浏览器
                                    </td>
                    ...
                    <div class="widget-content padding-horizontal-30">
                        <div class="table-responsive">
                            <table class="table table-analytics margin-bottom-0 text-nowrap">
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/country/china-icon.png" width="18" title="中国" alt="中国">
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/country/usa-icon.png" width="18" title="美国" alt="美国">
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/country/uk-icon.png" width="18" title="英国" alt="英国">
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/country/canada-icon.png" width="18" title="加拿大" alt="加拿大">
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/country/germany-icon.png" width="18" title="德国" alt="德国">
                                ...
                                <tr>
                                    <td>
                                        <img src="${ctx}/public/images/country/australia-icon.png" width="18" title="澳大利亚" alt="澳大利亚">
...
<script src="${ctx}/public/vendor/morris-js/morris.min.js" data-name="morris" data-deps="raphael"></script>
<script src="${ctx}/public/vendor/matchheight/jquery.matchHeight.min.js"></script>
<script src="${ctx}/public/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.js"></script>

<script src="${ctx}/public/js/examples/pages/home/analytics.js" data-deps="morris"></script>
