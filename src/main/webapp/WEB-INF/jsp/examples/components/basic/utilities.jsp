...
<link rel="stylesheet" href="${ctx}/public/css/examples/components/basic/utilities.css">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example-body">
                                ...
                                <div class="example example-box container-fluid">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="text-hide height-100" style="border:1px solid #e6e8ea; background-image: url(${ctx}/public/images/placeholder.png)">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 margin-bottom-10">
                                            <a class="avatar" href="javascript:;">
                                                <img class="width-50" src="${ctx}/public/images/portraits/1.jpg" alt="...">
                                            </a>
                                            <span class="text-top">测试文本</span>
                                        </div>
                                        <div class="col-md-4 margin-bottom-10">
                                            <a class="avatar" href="javascript:;">
                                                <img class="width-50" src="${ctx}/public/images/portraits/2.jpg" alt="...">
                                            </a>
                                            <span class="text-middle">测试文本</span>
                                        </div>
                                        <div class="col-md-4 margin-bottom-10">
                                            <a class="avatar" href="javascript:;">
                                                <img class="width-50" src="${ctx}/public/images/portraits/3.jpg" alt="...">
                                            </a>
