...
<title>字体图标 Weather Icons</title>
...
<div class="page animation-fade">
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <a class="btn btn-default btn-outline btn-round" href="http://erikflowers.github.io/weather-icons/" target="_blank">
    ...
    <div class="page-content container-fluid">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">v1.3 新增图标</h3>
            </div>
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">博福特风级表</h3>
            </div>
            <div class="panel-body container-fluid">
                <div class="row">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">风向 - 0度〜345度</h3>
            </div>
            <div class="panel-body container-fluid">
                <div class="row">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">v1.2 新增图标</h3>
            </div>
            <div class="panel-body container-fluid">
                <div class="row">
