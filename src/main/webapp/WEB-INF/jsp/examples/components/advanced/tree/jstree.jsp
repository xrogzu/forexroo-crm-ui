...
<script src="${ctx}/public/vendor/jstree/jstree.min.js" data-name="jstree"></script>
<script src="${ctx}/public/js/examples/components/advanced/jstree.js" data-deps="jstree"></script>
