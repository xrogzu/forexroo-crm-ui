    ...
    <div class="page-content container-fluid">
        <div class="row">
                        ...
                        <div class="row no-space">
                                ...
                                <div class="counter counter-lg counter-inverse bg-blue-600 vertical-align height-150">
                                    <div class="vertical-align-middle">
                                        <div class="counter-icon margin-bottom-5">
                                            <i class="icon wb-image" aria-hidden="true"></i></div>
                            ...
                            <div class="col-sm-4">
                                <div class="counter counter-lg counter-inverse bg-red-600 vertical-align height-150">
                                    <div class="vertical-align-middle">
                                        <div class="counter-icon margin-bottom-5">
                                            <i class="icon wb-video" aria-hidden="true"></i></div>
                            ...
                            <div class="col-sm-4">
                                <div class="counter counter-lg counter-inverse bg-purple-600 vertical-align height-150">
                                    <div class="vertical-align-middle">
                                        <div class="counter-icon margin-bottom-5">
                                            <i class="icon wb-envelope" aria-hidden="true"></i></div>
            ...
            <div class="col-lg-2 col-sm-6">
                ...
                <div class="widget">
                    <div class="widget-content padding-20 bg-orange-600 text-center vertical-align height-350">
                ...
                <div class="widget">
                    <div class="widget-content padding-20 bg-blue-600">
                        <div class="widget-watermark darker font-size-60 margin-15">
                            <i class="icon wb-clipboard" aria-hidden="true"></i></div>
            ...
            <div class="col-sm-6">
                ...
                <div class="widget">
                    <div class="widget-content padding-20 bg-red-600">
                        <div class="widget-watermark darker font-size-60 margin-15">
                            <i class="icon wb-users" aria-hidden="true"></i></div>
                        <div class="counter counter-md counter-inverse text-left">
                            <div class="counter-number-group">
                                <span class="counter-number">42</span>
                                <span class="counter-number-related text-capitalize">人</span>
            ...
            <div class="col-sm-6">
                ...
                <div class="widget">
                    <div class="widget-content padding-20 bg-green-600">
                        <div class="widget-watermark darker font-size-60 margin-15">
                            <i class="icon wb-musical" aria-hidden="true"></i></div>
                        <div class="counter counter-md counter-inverse text-left">
                            <div class="counter-number-group">
