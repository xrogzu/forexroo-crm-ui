...
<link rel="stylesheet" href="${ctx}/public/css/examples/components/widgets/social.css">
        ...
        <div class="row" data-plugin="matchHeight" data-by-row="true">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="widget widget-shadow text-center">
                    <div class="widget-header cover overlay" style="height: calc(100% - 100px);">
                        <img class="cover-image" src="${ctx}/public/images/photos/view-1.jpg" alt="..." style="height: 100%;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="widget widget-shadow">
                    <div class="widget-header cover overlay" style="height: calc(100% - 100px);">
                        <img class="cover-image" src="${ctx}/public/images/photos/view-2.jpg" alt="..." style="height: 100%;">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="widget widget-shadow">
                    <div class="widget-header cover overlay">
                        <div class="cover-background height-150" style="background-image: url('${ctx}/public/images/photos/view-3.jpg')"></div>
                    </div>
        ...
        <div class="row" data-plugin="masonry">
            ...
            <div class="col-md-6 col-xs-12 masonry-item">
                <div class="widget widget-shadow background-bottom">
                    <div class="widget-header cover overlay">
                        <div class="cover-background height-250" style="background-image: url(${ctx}/public/images/photos/view-4.jpg)"></div>
            ...
            <div class="col-md-6 col-xs-12 masonry-item">
                <div class="widget widget-shadow text-center">
                    <div class="widget-header cover overlay">
                        <div class="cover-background" style="background-image: url(${ctx}/public/images/photos/view-5.jpg)">
            ...
            <div class="col-md-6 col-xs-12 masonry-item">
                <div class="widget widget-shadow">
                    <div class="widget-header cover">
                        <div class="cover-background padding-30" style="background-image: url('${ctx}/public/images/photos/view-6.jpg')">
