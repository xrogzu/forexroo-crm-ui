                ...
                <div class="row row-lg">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <div class="cover">
                                    <div class="cover-background padding-vertical-30" style="background-image: url('${ctx}/public/images/photos/city-2.jpg')">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <div class="cover height-500 height-xs-300">
                                    <div class="cover-background" style="background-image: url('${ctx}/public/images/photos/city-1.jpg')"></div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="cover-gallery carousel slide" id="cover-gallery-example" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner" role="listbox">
                                            <div class="item active">
                                                <img alt="第1张图片" src="${ctx}/public/images/photos/city-4.jpg">
                                            </div>
                                            <div class="item">
                                                <img alt="第2张图片" src="${ctx}/public/images/photos/city-5.jpg">
                                            </div>
                                            <div class="item">
                                                <img alt="第3张图片" src="${ctx}/public/images/photos/city-6.jpg">
                                            </div>
                                        </div>
