                            ...
                            <div class="example">
                                <div class="media">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-1.jpg" alt="...">
                                        </a>
                                    </div>
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-2.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">媒体标题</h4>
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="javascript:;">
                                                    <img class="media-object" src="${ctx}/public/images/photos/view-3.jpg" alt="...">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <h4 class="media-heading">媒体标题</h4>
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-4.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">媒体标题</h4>
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <div class="media">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-5.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">媒体标题</h4>
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="javascript:;">
                                                    <img class="media-object" src="${ctx}/public/images/photos/view-6.jpg" alt="...">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="javascript:;">
                                                    <img class="media-object" src="${ctx}/public/images/photos/view-7.jpg" alt="...">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <h4 class="media-heading">嵌套媒体标题</h4>
                                ...
                                <div class="media">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-8.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">嵌套媒体标题</h4>
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <div class="media media-xs">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-9.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">媒体标题</h4>
                                ...
                                <div class="media media-sm">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-10.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">媒体标题</h4>
                                ...
                                <div class="media media">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-11.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">媒体标题</h4>
                                ...
                                <div class="media media-lg">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-12.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading">媒体标题</h4>
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <div class="media">
                                    <div class="media-left">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-13.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media">
                                    <div class="media-left media-middle">
                                        <a href="javascript:;">
                                            <img class="media-object" src="${ctx}/public/images/photos/view-14.jpg" alt="...">
                                        </a>
                                    </div>
                                    <div class="media-body">
