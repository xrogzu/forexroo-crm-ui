...
<link rel="stylesheet" href="${ctx}/public/css/examples/components/structure/chat.css">

<div class="page animation-fade">
    <div class="page-header">
        <h1 class="page-title">聊天窗口</h1>
                        ...
                        <div class="chat">
                            <div class="chat-avatar">
                                <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="June Lane">
                                    <img src="${ctx}/public/images/portraits/4.jpg" alt="June Lane">
                                </a>
                            </div>
                            <div class="chat-body">
                        ...
                        <div class="chat chat-left">
                            <div class="chat-avatar">
                                <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="Edward Fletcher">
                                    <img src="${ctx}/public/images/portraits/5.jpg" alt="Edward Fletcher">
                                </a>
                            </div>
                            <div class="chat-body">
                                <div class="chat-content">
